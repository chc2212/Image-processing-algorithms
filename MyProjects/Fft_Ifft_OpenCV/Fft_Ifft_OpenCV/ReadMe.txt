========================================================================
    콘솔 응용 프로그램 : Fft_Ifft_OpenCV 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 Fft_Ifft_OpenCV 응용 프로그램을 만들었습니다.

이 파일에는 Fft_Ifft_OpenCV 응용 프로그램을  구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.


Fft_Ifft_OpenCV.vcproj
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 Fft_Ifft_OpenCV.pch와
